  ...
  return (
    <div>
      <header className="flex justify-between items-center">
        <Link
          onClick={clearSaerchResults}
          to={"/main"}
          className="cursor-pointer flex flex-col items-center justify-center"
        >
          <img src="/logo.svg" className="w-18 md:w-20" alt="Logo" />
          <h2 className="font-bold text-xs md:text-sm">TRAVELMATE</h2>
        </Link>
              ...
              {user || luser ? (
                <>
                  <Link
                    ...
                    className="hover:text-primary hover:underline font-semibold text-lg"
                  >
                    Profile
                  </Link>
                  <Link
